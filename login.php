...
<head>
  ...
  <title>ZeoFlow - Log In / Sign Up</title>
  <meta property="og:title" content="ZeoFlow - Log In / Sign Up">
  ...
  <meta name="keywords" content="zeoflow, ZeoFlow, ZeoFlow Website, ZeoFlow Site, ZeoFlow Social, zeoflow create account, zeoflow sign up, login to zeoflow account, zeoflow login, zeoflow account">
  ...
  <script>
    history.pushState("null", "ZeoFlow - Log In / Sign Up", "/");
  </script>
